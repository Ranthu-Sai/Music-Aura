...
class LRUCacheManager {
    ...
    async _saveMetadata() {
        try {
            ...
            await AsyncStorage.setItem(this._getMetadataStorageKey(), JSON.stringify(metaObject));
        } catch (error) {}
    }
...
export const apiCache = new LRUCacheManager({ namespace: 'api_cache', maxEntries: 100 });
export const lyricsCache = new LRUCacheManager({ namespace: 'lyrics_cache', maxEntries: 50 });
