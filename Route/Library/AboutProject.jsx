...
import { Linking, Pressable, ScrollView, View, StyleSheet, Dimensions, StatusBar } from "react-native";
      ...
      >
        ...
        >
          ...
          <View style={styles.socialRow}>
            ...
            <SocialIcon
              icon="linkedin"
              color="#0077b5"
              onPress={() => openURL("https://www.linkedin.com/in/sai-ranthu-73b352295/")}
            />
            <SocialIcon
              icon="instagram"
              color="#e4405f"
              onPress={() => openURL("https://www.instagram.com/s.a.i_r.a.n.t.u/")}
            />
          </View>
        </LinearGradient>
        ...
        <View style={styles.communityRow}>
          <CommunityCard
            ...
            onPress={() => openURL("https://github.com/Ranthu-Sai/Music-Aura.git")}
          />
        </View>
