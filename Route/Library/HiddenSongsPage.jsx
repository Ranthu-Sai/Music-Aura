...
export const HiddenSongsPage = () => {
    ...
    const handleUnhide = useCallback(async (song) => {
        try {
    ...
    const renderItem = ({ item }) => (
        <View style={{
            ...
            >
                <Text style={{ color: 'white', fontSize: 13, fontWeight: '600' }}>Unhide</Text>
            </TouchableOpacity>
        </View>
    );
        ...
        <View style={{ flex: 1, backgroundColor: 'black' }}>
            ...
            {isLoading ? (
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text style={{ color: 'white', marginTop: 10 }}>Loading hidden songs...</Text>
                </View>
            ) : hiddenSongs.length === 0 ? (
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40 }}>
                    <MaterialCommunityIcons name="eye-off" size={64} color="rgba(255,255,255,0.2)" />
                    <Text style={{ color: 'white', fontSize: 18, fontWeight: '600', marginTop: 20, textAlign: 'center' }}>
                        No Hidden Songs
                    </Text>
