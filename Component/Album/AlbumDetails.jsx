...
export const AlbumDetails = ({
  ...
  const computeAlbumName = () => {
    ...
    if (
      cleanedRawAlbum &&
      cleanedRawAlbum !== cleanedSongTitle &&
      cleanedRawAlbum !== 'N/A'
    ) {
    ...
    if (albumFromSongField) {
      const extracted =
        extractFromPattern(albumFromSongField) || cleanText(albumFromSongField);
      if (extracted && extracted !== cleanedSongTitle && extracted !== 'N/A') {
        return extracted;
      }
    }
    ...
    if (extractedFromTitle && extractedFromTitle !== cleanedSongTitle) {
      return decodeHtmlEntitiesLocal(extractedFromTitle);
    }
