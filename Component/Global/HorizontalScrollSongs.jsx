...
export const HorizontalScrollSongs = React.memo(({ id }) => {
  ...
  const shouldRender = useMemo(() => id && playlistName !== "Trending Today", [id, playlistName]);
  ...
  return (<>
    <Spacer />
    <Spacer />
    <Heading text={Loading ? "Please Wait..." : playlistName} nospace={true} />
    <Spacer />
    {!Loading && songs.length > 0 && <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
      <View>
