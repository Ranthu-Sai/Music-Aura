...
export const ShowLyrics = ({
  ...
  useEffect(() => {
    ...
    const shouldAutoScroll =
      !isManualScrolling && timeSinceManualScroll > MANUAL_SCROLL_DELAY;
    ...
    <Modal
      ...
      <View
        ...
        <LinearGradient
          ...
          colors={['transparent', getBackgroundColor, getBackgroundColor]}
          style={{
            flexDirection: 'row',
            gap: 4,
            position: 'absolute',
          ...
          <Pressable
            onPress={() =>
              Clipboard.setString(Lyric?.lyrics?.replaceAll('<br>', '\n') ?? '')
            }
            style={{
              flex: 1,
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.optionsRow}>
              {['Small', 'Medium', 'Large', 'Extra'].map(size => (
                <Pressable
                  ...
                  style={[
                    styles.optionButton,
                    lyricsSettings.fontSize === size && styles.activeOption,
                  ]}>
                  <Text
                    style={[
                      styles.optionText,
                      lyricsSettings.fontSize === size &&
            ...
            <View style={styles.optionsRow}>
              {[
                ...
                <Pressable
                  key={bg.name}
                  onPress={() => handleUpdateSetting('background', bg.val)}
                  style={[
                    styles.optionButton,
                    lyricsSettings.background === bg.val &&
                      styles.activeOption,
                  ]}>
                  <Text
                    style={[
            ...
            <View style={styles.optionsRow}>
              {[
                ...
                <Pressable
                  ...
                  style={[
                    styles.optionButton,
                    lyricsSettings.textColor === color.val &&
                      styles.activeOption,
                  ]}>
                  <View
                    style={{
            ...
            <View style={styles.optionsRow}>
              {['Smooth', 'Standard', 'Static'].map(anim => (
                <Pressable
                  ...
                  style={[
                    styles.optionButton,
                    lyricsSettings.animation === anim && styles.activeOption,
                  ]}>
                  <Text
                    style={[
                      styles.optionText,
                      lyricsSettings.animation === anim &&
                        styles.activeOptionText,
                    ]}>
                    {anim}
                  </Text>
