  ...
  return (
    <>
      ...
      <View
        ...
        <EachSmallCardHome
          name={playlist[Random1].title}
          image={playlist[Random1].image[2].link}
          isPlaylist={true}
          subtitle={playlist[Random1].subtitle}
          id={playlist[Random1].id}
        />
        <EachSmallCardHome
          name={playlist[Random2].title}
          image={playlist[Random2].image[2].link}
          isPlaylist={true}
          subtitle={playlist[Random2].subtitle}
          id={playlist[Random2].id}
        />
      </View>
    </>
  );
